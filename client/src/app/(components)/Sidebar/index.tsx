...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col justify-between shadow-xl transition-all duration-300 h-full z-40 dark:bg-black overflow-y-auto bg-white h-full ${isSidebarCollapsed ? 'w-0 hidden' : 'w-64'}`;

  return (
    <div className={sidebarClassNames}>
      <div className='flex h-full w-full flex-col justify-start'>
        {/* TOP LOGO */}
        <div className='z-50 flex min-5-[56px] w-64 items-center justify-between bg-white px-6 py-3 dark:bg-black'>
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
          <Image src="/logo-set.png" alt="logo" width={40} height={40} />
          <div>
